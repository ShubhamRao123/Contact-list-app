...
public class ContactDataSource {
    ...
    public boolean insertContact(Contact c) {
        ...
        try {
            ...
            System.out.println("venu" + didSucceed);
        } catch (Exception e) {
            System.out.println(e.getLocalizedMessage() + "venu");
        }
        return didSucceed;
    }
    ...
    public boolean updateContact(Contact c) {
        ...
        try {
            ...
            System.out.println("venu updTE " + didSucceed);
        } catch (Exception e) {
    ...
    public ArrayList<Contact> getContacts(String sortField, String sortOrder) {
        ...
        try {
            ...
            while (!cursor.isAfterLast()) {
                ...
                newContact.setMail(cursor.getString(8));
                Time t = new Time();
            ...
            System.out.println("venu" + e.getLocalizedMessage());
        }
        return contacts;
    }
